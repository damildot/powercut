...
// Diagnostic route'lar - token korumalı, rate limited (dakikada 10 istek)
// .env: CACHE_TOKEN=gizli_kelimen
Route::middleware('throttle:diagnostic')->group(function () {

    // Cache temizleme - /pc-flush?token=xxx
